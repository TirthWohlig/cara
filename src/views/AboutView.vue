<template>
  <div class="about">
    ...
    <div class="container1">
      <img width="100%" height="auto" src="../assets/aboutnew.png" />
        ...
        <v-row>
          <v-col cols="12" md="6">
            ...
            <p class="font">
              ...
              know it, our platform becomes yours, and your choices come to
              life.
            </p>
          </v-col>
          <v-col cols="12" md="6">
    ...
    <div>
      <v-container>
        <v-row>
          ...
          <v-col cols="12" md="6">
            <h2 class="font">Why we started</h2>
            <br />
            <p class="font">
