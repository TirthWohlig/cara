<template>
  <div>
    <Header />
    <v-row>
      <v-col cols="12" md="3" v-for="items in bandhgalas" :key="items">
...
export default {
  ...
  mounted() {
    axios.get("http://localhost:3000/bandhgalas").then((response) => {
      this.bandhgalas = response.data;
      console.log(this.bandhgalas);
    });
  },
  components: {
    Header,
